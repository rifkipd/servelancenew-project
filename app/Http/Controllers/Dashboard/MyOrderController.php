...
use App\Http\Requests\Dashboard\MyOrder\UpdateMyOrderRequest as MyOrderUpdateMyOrderRequest;
...
class MyOrderController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(MyOrderUpdateMyOrderRequest $request, Order $order)
    {
        $data = $request->all();
        if(isset($data['file'])){
