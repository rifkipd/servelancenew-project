...
use App\Http\Requests\Dashboard\Service\StoreServiceRequest as ServiceStoreServiceRequest;
use App\Http\Requests\Dashboard\Service\UpdateServiceRequest as ServiceUpdateServiceRequest;
...
class ServiceController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ServiceUpdateServiceRequest $request, Service $service)
    {
        $data = $request->all();
