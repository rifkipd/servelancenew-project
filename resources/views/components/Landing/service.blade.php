    ...
    <div class="w-96 h-auto overflow-hidden md:p-5 p-4 bg-white rounded-2xl inline-block">
        <div class="flex items-center space-x-2 mb-6">
           ...
           @if ($item->user->detail_user->photo != NULL)
               <img class="w-14 h-14 object-cover rounded-full mr-1" src="{{ url(Storage::url($item->user->detail_user->photo)) }}" 
               alt="photo freelancer" loading="lazy">
           @else
               <svg class="w-14 h-14 object-cover object-center rounded-full mr-1 text-gray-300"
               fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.25 2.354 11.996 5.
                    993zM16.002 8.99a4 4 0 11-8 0 4 4 0 018 0z"/>
                </svg>
           @endif
            <div>
                <!--Author name-->
